                      ...
                      <AutoRow gap="4px">
                        ...
                        <TYPE.main fontSize={20} lineHeight={1} fontWeight={500}>
                          <RowFixed>
                            ...
                            <FormattedName text={token0?.symbol ?? ''} maxCharacters={SYMBOL_MAX_DISPLAY_LENGTH} margin={true} />
                          </RowFixed>
                        </TYPE.main>
                      </AutoRow>
                    </Hover>
                      ...
                      <AutoRow gap="4px">
                        ...
                        <TYPE.main fontSize={20} lineHeight={1} fontWeight={500}>
                          <RowFixed>
                            ...
                            <FormattedName text={token1?.symbol ?? ''} maxCharacters={SYMBOL_MAX_DISPLAY_LENGTH} margin={true} />
                          </RowFixed>
                        </TYPE.main>
                      </AutoRow>
                    </Hover>
                ...
                <TokenDetailsLayout>
                  <Column>
                    ...
                    <TYPE.main style={{ marginTop: '.5rem' }}>
                      <RowFixed>
                        <FormattedName text={token0?.symbol ?? ''} maxCharacters={SYMBOL_MAX_DISPLAY_LENGTH} />
                        -
                        <FormattedName text={token1?.symbol ?? ''} maxCharacters={SYMBOL_MAX_DISPLAY_LENGTH} />
                      </RowFixed>
                    </TYPE.main>
                  </Column>
                  <Column>
